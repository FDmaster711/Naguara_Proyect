...
\restrict TjkY9V2wdLwyMJGsxyQDoi5Wx9FeQKOnxmZfxbeYNua3d4osXHGjNwKopGnJO1x
...
2	tarjeta	Tarjeta	f	2025-11-30 16:34:56.779403
\.
...
16	3.50	1.80	191.00	unidad	2025-10-24 18:53:42.73315	3	Aliño Completo NaGuara	0.02	3	10.00	1	Activo
20	1560.00	1000.00	45.00	kg	2025-11-23 14:19:05.940287	4	jamon de pierna	6.59	2	10.00	2	Activo
13	5.50	3.50	50.00	unidad	2025-11-23 16:09:58.702282	2	Milanesa de Pollo Clásica	0.03	1	10.00	1	Activo
22	90.00	40.00	49.00	kg	2025-11-30 16:28:24.513434	1	morcilla	\N	1	20.00	2	Activo
10	25.00	18.50	33.00	kg	2025-11-23 14:20:21.493999	1	Pollo Entero Premium	0.12	1	50.00	1	Activo
11	45.00	32.00	86.07	kg	2025-11-23 16:09:58.702282	1	Pecho de Pollo	0.19	1	10.00	1	Activo
19	150.00	90.00	80.90	kg	2025-11-23 14:20:30.411127	1	Pollo picado	0.63	1	10.00	2	Activo
18	5.80	2.90	178.00	unidad	2025-11-30 16:32:06.596113	3	Adobo Tradicional	0.03	3	10.00	1	Activo
14	6.80	4.20	71.00	unidad	2025-11-30 16:32:40.926087	2	Milanesa de Pollo Especial	0.03	1	10.00	1	Activo
\.
...
1	16.00	IVA General	general	Activa	2025-11-15 20:47:15.542161	2025-11-30 16:36:01.433647
\.
...
3	2025-11-30 16:30:23.946576	1	10	10.00	floivnhbdoñhbv
\.
...
1	Usuario Demo	admin	$2b$10$aTWDxi.hlZhb8Aak/kKzAOn1aPeMa8b4s7KyxrR5WDZZGALNq6rjq	Super Admin	Activo	2025-11-02 12:55:48.732599	2025-11-30 16:35:07.183961
...
SELECT pg_catalog.setval('public.detalle_compra_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.detalle_venta_id_seq', 62, true);
...
SELECT pg_catalog.setval('public.historial_inventario_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.tasa_cambio_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.transformacion_detalles_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.transformacion_producto_id_seq', 3, true);
...
\unrestrict TjkY9V2wdLwyMJGsxyQDoi5Wx9FeQKOnxmZfxbeYNua3d4osXHGjNwKopGnJO1x
